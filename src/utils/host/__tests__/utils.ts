...
import { CONTENT_WRAPPER_CLASS, NOTRANSLATE_CLASS, TRANSLATION_MODE_ATTRIBUTE, TRANSLATION_MODE_VALUE } from "@/utils/constants/dom-labels"
...
export function expectTranslationWrapper(node: Element, mode: TranslationMode) {
  ...
  expect(wrapper).toHaveAttribute(TRANSLATION_MODE_ATTRIBUTE, TRANSLATION_MODE_VALUE[mode])
