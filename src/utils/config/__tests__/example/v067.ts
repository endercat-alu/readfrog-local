...
import { testSeries as v066TestSeries } from "./v066"
...
export const testSeries: TestSeriesObject = Object.fromEntries(
  Object.entries(v066TestSeries).map(([seriesId, seriesData]) => {
    const oldPageConfig = seriesData.config.translate?.page ?? {}
